...
const Landing = () => {
    ...
    const [password, setPassword] = useState(cookies.get('password') ? cookies.get('password') : "");
    const [subdomain, setSubdomain] = useState(cookies.get('subdomain') ? cookies.get('subdomain') : "");
    ...
    return (
        <div className="center-content-vertically">
            ...
            <Row className="mb-4">
                <Col sm={{ span: 4, offset: 2 }}>
                    <InputGroup >
                        ...
                        <FormControl type="email" placeholder="example@gmail.com" value={username} onInput={e => setUsername(e.target.value)} />
                    </InputGroup>
                </Col>
                <Col sm={{ span: 4 }}>
                    <InputGroup >
                        <InputGroup.Text className="bg-secondary">Password</InputGroup.Text>
                        <FormControl type="password" value={password} onInput={e => setPassword(e.target.value)} />
                    </InputGroup>
                </Col>
            </Row>
            <Row className="mb-4">
                <Col sm={{ span: "auto", offset: 4 }}>
                    <InputGroup >
                        ...
                        <FormControl value={subdomain} onInput={e => setSubdomain(e.target.value)} />
            ...
            <Row>{cookies.get("username") + " " + cookies.get("password") + " " + cookies.get("subdomain")}</Row>
